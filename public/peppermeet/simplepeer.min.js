            ...
            1: [
                function (e, t, n) {
                    ...
                    function o(e) {
                        ...
                        return (
                            2 === s &&
                                ((t = (u[e.charCodeAt(n)] << 2) | (u[e.charCodeAt(n + 1)] >> 4)), (l[c++] = 255 & t)),
                            1 === s &&
                                ((t =
                                    (u[e.charCodeAt(n)] << 10) |
                ...
                function (e, t) {
                    ...
                    function i(e, t, r, i) {
                        ...
                        if (
                            ...
                            ('function' == typeof l ? (l = s[t] = i ? [r, l] : [l, r]) : i ? l.unshift(r) : l.push(r),
                            (d = o(e)),
                    ...
                    ;(function (n, r) {
                        ;(function () {
                            ...
                            function S(e, t) {
                                ...
                                if (
                                    n &&
                                    (w(e, t), 0 === t.pendingcb && ((t.finished = !0), e.emit('finish'), t.autoDestroy))
                                ) {
                ...
                function (e, t) {
                    ...
                    class p extends d.Duplex {
                        ...
                        _setupData(e) {
                            if (!e.channel)
                                return this.destroy(
                                    l(new Error('Data channel event is missing `channel` property'), 'ERR_DATA_CHANNEL')
                                )
                        ...
                        _onIceStateChange() {
                            ...
                            ;(this._debug('iceStateChange (connection: %s) (gathering: %s)', e, t),
                                ...
                                'failed' === e &&
                                    this.destroy(l(new Error('Ice connection failed.'), 'ERR_ICE_CONNECTION_FAILURE')),
                                'closed' === e &&
