    ...
    presets: [
        {
            theme: {
                extend: {
                    ...
                    inset: (({ theme, negative }: { theme: any; negative: any }) => ({
                        auto: 'auto',
                        ...theme('spacing'),
                    ...
                    margin: (({ theme, negative }: { theme: any; negative: any }) => ({
                        auto: 'auto',
                        ...theme('spacing'),
                        ...negative(theme('spacing'))
                    })) as any,
                    ...
                    space: (({ theme, negative }: { theme: any; negative: any }) => ({
                        ...theme('spacing'),
                        ...negative(theme('spacing'))
                    })) as any,
                    stroke: {
                    ...
                    translate: (({ theme, negative }: { theme: any; negative: any }) => ({
                        ...theme('spacing'),
                        ...negative(theme('spacing')),
                        '1/2': '50%',
                        '1/3': '33.333333%',
